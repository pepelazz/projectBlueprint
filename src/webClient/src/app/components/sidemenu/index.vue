            ...
            return {
                menuLinks: [
                    // for codeGenerate ##sidemenu_slot1
									...
									{icon: 'https://image.flaticon.com/icons/svg/469/469323.svg', text: 'ЮрЛица', url: '/legal_entity', roles: []},
{isFolder: true, icon: 'https://image.flaticon.com/icons/svg/1643/1643260.svg', text: 'Справочники', roles: [], linkList: 								[
								{icon: 'https://image.flaticon.com/icons/svg/469/469323.svg', text: 'ЮрЛица', url: '/legal_entity', roles: []},
],},
{isFolder: true, icon: 'https://image.flaticon.com/icons/svg/1642/1642808.svg', text: 'Задачи', roles: [], linkList: 								[
								{icon: '', text: 'Список задач', url: '/task', roles: []},
								{icon: '', text: 'Типы задач', url: '/taskType', roles: []},
],},
